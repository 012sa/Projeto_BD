...
public void create(Concorrente c){
        ...
        try {
            ...
            stmt = con.prepareStatement("INSERT INTO concorrente_tb (nome, numero) VALUES (?)");
            //get dos atrubutos
    ...
    public void delete(Concorrente c){
        ...
        try {
            //onde ficará o insert
            stmt = con.prepareStatement("DELETE FROM concorrente_tb WHERE idEmpresa = ? ");
            //get dos atrubutos
            stmt.setInt(1,c.getIdEmpresa());
